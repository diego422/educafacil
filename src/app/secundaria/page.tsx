    ...
    <div className="min-h-screen flex flex-col">
      ...
      <header className="bg-gradient-to-r from-green-500 to-green-600 p-4 shadow-md">
        <div className="container mx-auto flex flex-col md:flex-row items-center justify-between">
          <div className="flex items-center gap-3 mb-4 md:mb-0">
            ...
            <h1 className="text-2xl font-bold text-white">Educación Secundaria</h1>
          </div>
      ...
      <main className="flex-1 container mx-auto py-8 px-4">
        <div className="bg-green-50 p-6 rounded-lg mb-8">
          <h2 className="text-2xl font-bold text-green-800 mb-4">Bienvenido a Secundaria</h2>
        ...
        <section className="mb-12">
          <h2 className="text-3xl font-bold mb-6 text-center text-green-700">Selecciona tu Grado</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {[7, 8, 9, 10, 11].map((grado) => (
              <Link href={`/secundaria/${grado}`} key={grado} className="block">
                <Card className="hover:shadow-lg transition-shadow border-2 border-green-200 bg-green-50">
                  <CardContent className="p-6 text-center">
                    <div className="text-6xl font-bold text-green-600 mb-4">{grado}°</div>
                    <h3 className="text-xl font-bold text-green-800 mb-2">{grado}° Grado</h3>
                    <p className="text-green-700 mb-4">
                      Recursos educativos para estudiantes de {grado}° grado de secundaria
                    </p>
